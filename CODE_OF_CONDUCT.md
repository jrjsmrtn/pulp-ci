<!--
SPDX-FileCopyrightText: 2014 The Contributor Covenant authors
SPDX-FileCopyrightText: 2026 Georges Martin <jrjsmrtn@gmail.com>
SPDX-License-Identifier: CC-BY-4.0
-->

> **This project has a single maintainer**, who is also the only person enforcing this code
> of conduct. Reports go to them privately and are read only by them. If your report is
> about the maintainer, there is nobody else within the project to take it to: report it to
> GitHub instead, through
